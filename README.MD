...
Note: The current version of Lycanthropy is in an extremely fragile state due to over-engineering on networking components. Efforts are being made to re-engineer broken code to be more stable. 
