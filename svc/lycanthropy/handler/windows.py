...
def wmiHotfix(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiHotfix',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiService(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiService',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiUser(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiUser',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiInstalled(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiInstalled',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiAutorun(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiAutorun',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiProcess(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiProcess',lycanthropy.crypto.mkRandom(6),'windows')
...
def wmiEnvironment(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiEnvironment',lycanthropy.crypto.mkRandom(6),'windows')
    return {'output': apiResponse.content.decode('utf-8'), 'context': 'windows(wmi.autorun)', 'form': restoredForm}
...
def wmiShare(arguments,context,connector):
    ...
    apiResponse = lycanthropy.portal.api.apiBroker().passGeneric(arguments,connector,'wmiShare',lycanthropy.crypto.mkRandom(6),'windows')
